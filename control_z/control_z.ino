...
double ref = 1.0, yN = 0.0, uN_0 = 0.0, uN_1 = 0.0, errN_0 = 0.0, errN_1 = 0.0, errN_2 = 0.0;
...
void loop()
{
  double yN = pwm2real(analogRead(VOLTAGEREADPIN));
  ...
  Serial.println("Output value: " + String(yN));
};
